...
def extract_financials(text: str) -> dict:
    keywords = {
        ...
        "BS_TRADE_RECEIVABLES": [r"phải thu ngắn hạn của khách hàng", r"phải thu khách hàng"],
        ...
        for code, patterns in keywords.items():
            ...
            for pattern in patterns:
                if re.search(pattern, line):
                    ...
                    if numbers:
                        # Convert 1.000.000 or 1,000,000 to float
...
test_text = """
Tài sản ngắn hạn 120.000.000.000
Doanh thu thuần về bán hàng và cung cấp dịch vụ 318,000,000,000
Chi phí lãi vay: 18.500.000.000
Lợi nhuận sau thuế của thu nhập doanh nghiệp 50.000.000.000
"""

print(extract_financials(test_text))
