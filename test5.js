    ...
    function confirmNewCustomerSession() {
      ...
      document.getElementById('eb-docs-list').innerHTML = '<div class="p-3 text-center text-slate-400 text-[10px] border border-dashed rounded-lg">Chưa có tài liệu nào</div>'; document.getElementById('ai-insight-box').classList.add('hidden');
